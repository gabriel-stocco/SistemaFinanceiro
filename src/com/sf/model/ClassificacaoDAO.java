...
public class ClassificacaoDAO {
	...
	public String salvar(Classificacao c) {
		...
		try {
			bd.getConnection();
			bd.st = bd.con.prepareStatement(sql);
			bd.st.setInt(1, c.getIdClassificacao());
			bd.st.setString(2, c.getNomClassificacao());
			bd.st.executeUpdate();
			men = "Classificação "+c.getNomClassificacao() + " inserido com sucesso!";
			...
			try {
				...
				bd.st.executeUpdate();
				men = "Classificação "+c.getNomClassificacao() + " alterado com sucesso!";
